...
<template>
  <div
    ...
    :class="[
      isDragging
        ...
        : 'border-[var(--border-default)] hover:border-[var(--border-dark)]',
  ...
  >
    ...
    <div v-else class="flex flex-col items-center gap-1">
      ...
      <span class="text-sm text-[var(--text-secondary)]">点击或拖拽上传文件</span>
      <span class="text-xs text-[var(--text-tertiary)]">支持 PDF、Word、Excel、图片、文本（最多5个，单个10MB）</span>
    </div>
  </div>
</template>
